...
window.addEventListener('DOMContentLoaded', function () {
  var $elem = document.querySelector('.titleeffect');
  var isVisible = $elem.classList.contains('titleeffect-visible');
  console.log(isVisible); // domを生成
  ...
  if (isVisible) {
    ...
    var clone = '<span class="titleeffect__clone">'.concat(text, '</span>');
    var cover = '<span class="titleeffect__cover">'.concat(text, '</span>');
    var copy = '<span class="titleeffect__df">'.concat(text, '</span>');
  ...
  if (!isVisible) {
    var $clone = document.querySelector('.titleeffect__clone');
    var $cover = document.querySelector('.titleeffect__cover');
    console.log($clone);
    var elemHeight = $elem.offsetHeight;
    var elemWidth = $elem.offsetWidth;
    var n = "rect(0px 0px ".concat(elemHeight, "px 0px)");
    var r = "rect(0px ".concat(elemWidth, "px ").concat(elemHeight, "px 0px)");
    var o = "rect(0px ".concat(elemWidth, "px ").concat(elemHeight, "px 0px)");
    var s = "rect(0px ".concat(elemWidth, "px ").concat(elemHeight, "px ").concat(elemWidth, "px)");
    $clone.style.clip = n;
    $cover.style.clip = o;
    ...
    gsap.to($cover, 1.5, {
      ...
      onComplete: function onComplete() {
        $elem.classList.add('titleeffect-animated'), $clone.remove(), $cover.remove();
      }
    });
  }
}, false);
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "d36ad43d9445d054a7dd"; }
/******/ 	}();
/******/ 	
