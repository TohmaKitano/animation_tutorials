...
window.addEventListener('DOMContentLoaded', function () {
  // Get DOM Element
  var titEffect = document.querySelector('.titEffect');
  var isTitVisible = titEffect.classList.contains('titEffect-visible'); // Create New DOM Content
  ...
  function creareNewTitEffectContent(bool, el) {
    if (bool) {
      ...
      var titEffectContent = el.textContent,
    ...
    if (!bool) {
      ...
      gsap.to(newTitEffectCover, 1.5, {
        ...
        onComplete: function onComplete() {
          titEffect.classList.add('titEffect-animated'), newTitEffectClone.remove(), newTitEffectCover.remove();
        }
      });
    }
  }
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "571857c65768cfd36d8c"; }
/******/ 	}();
/******/ 	
